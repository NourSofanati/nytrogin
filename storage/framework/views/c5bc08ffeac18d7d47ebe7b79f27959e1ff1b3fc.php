    ...
    <div class="bg-white shadow-xl rounded p-2">
        ...
        <div class="py-4 px-8 ">
            ...
            <div class="flex flex-col gap-4 mt-5 max-h-[500px] overflow-y-auto">
                <form method="POST" action="<?php echo e(route('assign_dep')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <select name="dpm_id" id="dpm_id" class="border-2 border-gray-400 w-full">
                        <?php $__currentLoopData = \App\Models\User::where('role_id', \App\Models\Role::IS_PROJECT_MANAGER)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->id); ?>"><?php echo e($item->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                    <button type="submit"
                        class="bg-[#673B8C] text-white px-4 py-2 rounded-xl text-lg w-full mt-3 shadow-lg"><?php echo e(__('تعين مدير المشروع')); ?></button>
                </form>
            </div>
        </div>
    </div>
...
<?php $__env->startPush('custom-scripts'); ?>
    <script>
        $('#manager_exit_button').click(function(e) {
            e.preventDefault();
            $('#assignManagerModal').addClass('hidden');
        });
        $('#showAssignManager').click(function(e) {
            e.preventDefault();
            $('#assignManagerModal').removeClass('hidden');
        });
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\nour\Desktop\Nytrogin\nytrogin\resources\views/org_project/modals/assignManagerModal.blade.php ENDPATH**/ ?>